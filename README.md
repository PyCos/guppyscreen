...
#### Material (Nightly)
``` FIXED 2026.03.16.
sh -c "$(wget --no-check-certificate -qO - https://raw.githubusercontent.com/PyCos/guppyscreen-PyCos-fork/refs/heads/main/scripts/installer.sh?token=GHSAT0AAAAAADT6LBMJQLHQXOG3Y42LCGRM2NYKSIQ)" -s nightly
```
